...
| Algorithms     | Regression and Classification algorithms available to build models.   | The user must select at least one of them. *CompareML* allows users to choose between the Linear Regression, Decision Tree and Boosted Decision Trees Regression algorithms and the Random Forest, Logistic Regression, and Support Vector Machine Classification algorithms. |
...
<p align="center">
  <img width="auto" height="220" src="https://raw.githubusercontent.com/i3uex/CompareML/master/public/img/R2.png">
</p>
